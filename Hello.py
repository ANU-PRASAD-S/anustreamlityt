...
icon = Image.open("/workspaces/anustreamlityt/youtube logo.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Anu Prasad",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Anu Prasad!*"""})
...
if selected == "Home":
    ...
    col2.markdown("#   ")
    col2.markdown("#   ")
    col2.image("/workspaces/anustreamlityt/youtube logo.png")
